            ...
            <div className='componentFour'>
                <div className='supportComponent'>
                    ...
                    <div className='d-flex justify-content-center'>
                        <p className='notHeading'>Not Just a Software. A True Partner In Your Sales Success.</p>
                    </div>
                    <div className='d-flex justify-content-center'>
                        <div className='d-flex supportBoxList'>
                            <div className='d-flex align-items-center justify-content-between supportBox'>
                ...
                <div className='securityComponent position-relative'>
                    ...
                    <p className='securityHeading'>SECURITY AND PRIVACY</p>
                    <div className='d-flex justify-content-center'>
                        <p className='enterpriceHeading'>Enterprise-Grade Security And Reliable Platform Uptime</p>
                    </div>
                    ...
                    <div className='d-flex justify-content-center'>
                        <div className='securityList d-flex'>
                            <div className='securityBox'>
                                <img src={securityBoxImg1} alt="" />
                                <p className='securityTime'>2.5 min</p>
                                <p className='securityBoxContent'>Support Response Time</p>
                            </div>
                            <div className='securityBox'>
                                <img src={securityBoxImg2} alt="" />
                                <p className='securityTime'>2.5 min</p>
                                <p className='securityBoxContent'>Support Response Time</p>
                            </div>
                            <div className='securityBox'>
                                <img src={securityBoxImg3} alt="" />
                                <p className='securityTime'>2.5 min</p>
                                <p className='securityBoxContent'>Support Response Time</p>
                            </div>
                            <div className='securityBox'>
                                <img src={securityBoxImg4} alt="" />
                                <p className='securityTime'>2.5 min</p>
                                <p className='securityBoxContent'>Support Response Time</p>
                            </div>
                            <div>
                                <img src={securityBoxImg5} alt="" />
                            </div>
                            <div>
                                <img src={securityBoxImg6} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
