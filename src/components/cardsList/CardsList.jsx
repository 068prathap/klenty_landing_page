        ...
        <>
            <div className=''>
                <div className='d-flex justify-content-center'>
                    <p className='cardsHeading mb-1'>Everything You Need to Run Your Sales Process. In One Platform.</p>
                </div>
                <div className='d-flex justify-content-center align-items-center cradsList mt-5'>
                    <div className='d-flex innerCradsList'>
